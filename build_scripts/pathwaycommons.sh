...
#./scripts/pathway_db.py build --organism 9606 --dogma data/simple_dogma.yaml --exclude data/exclude.list --all library $DATADIR/Pathway_Commons.4.All.BIOPAX.library --spf --min-subgraph 2 --exclude-type chemical > $DATADIR/Pathway_Commons.4.All.BIOPAX.library.9606.spf

./scripts/pathway_db.py build --organism 9606 --dogma data/simple_dogma.yaml --exclude data/exclude.list --all library $DATADIR/Pathway_Commons.4.All.BIOPAX.library --spf --exclude-type chemical > $DATADIR/Pathway_Commons.4.All.BIOPAX.library.9606.spf
...
./scripts/pathway_db.py library-copy --dogma data/simple_dogma.yaml --exclude data/exclude.list --all $DATADIR/Pathway_Commons.4.All.BIOPAX.library $DATADIR/Pathway_Commons.4.All.BIOPAX.spf.zip
